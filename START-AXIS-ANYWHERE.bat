...
echo.
echo   He's called Jarvis now - this is START-JARVIS-ANYWHERE.bat
echo.

if not exist "START-JARVIS-ANYWHERE.bat" goto missing
call "START-JARVIS-ANYWHERE.bat" %*
exit /b %ERRORLEVEL%

:missing
echo   START-JARVIS-ANYWHERE.bat isn't in this folder, so there is nothing to hand over to.
