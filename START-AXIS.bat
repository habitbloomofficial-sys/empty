...
echo.
echo   He's called Jarvis now - this is START-JARVIS.bat
echo.

if not exist "START-JARVIS.bat" goto missing
call "START-JARVIS.bat" %*
exit /b %ERRORLEVEL%

:missing
echo   START-JARVIS.bat isn't in this folder, so there is nothing to hand over to.
