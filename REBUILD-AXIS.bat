...
echo.
echo   He's called Jarvis now - this is REBUILD-JARVIS.bat
echo.

if not exist "REBUILD-JARVIS.bat" goto missing
call "REBUILD-JARVIS.bat" %*
exit /b %ERRORLEVEL%

:missing
echo   REBUILD-JARVIS.bat isn't in this folder, so there is nothing to hand over to.
