...
echo.
echo   He's called Jarvis now - this is CHECK-JARVIS.bat
echo.

if not exist "CHECK-JARVIS.bat" goto missing
call "CHECK-JARVIS.bat" %*
exit /b %ERRORLEVEL%

:missing
echo   CHECK-JARVIS.bat isn't in this folder, so there is nothing to hand over to.
