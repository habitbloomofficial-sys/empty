...
const vertexShader = /* glsl */ `
  ...
  void main() {
    ...
    float n1 = snoise(position * 1.6 + uTime * 0.25);
    float n2 = snoise(position * 3.2 - uTime * 0.18) * 0.5;
    float displacement = (n1 + n2) * uIntensity;
...
const fragmentShader = /* glsl */ `
  ...
  void main() {
    ...
    vec3 base = mix(uColorCore, uColorEdge, clamp(vDisplacement * 1.6 + 0.5, 0.0, 1.0));
    vec3 color = base + fresnel * uColorEdge * 1.4;
