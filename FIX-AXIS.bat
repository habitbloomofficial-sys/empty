...
echo.
echo   He's called Jarvis now - this is FIX-JARVIS.bat
echo.

if not exist "FIX-JARVIS.bat" goto missing
call "FIX-JARVIS.bat" %*
exit /b %ERRORLEVEL%

:missing
echo   FIX-JARVIS.bat isn't in this folder, so there is nothing to hand over to.
